...
static const _SystemState_type_support_symbol_names_t _SystemState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ranger_msgs, msg, SystemState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ranger_msgs, msg, SystemState)),
  }
};
...
{
  return &::ranger_msgs::msg::rosidl_typesupport_cpp::SystemState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ranger_msgs, msg, SystemState)() {
  return get_message_type_support_handle<ranger_msgs::msg::SystemState>();
}
