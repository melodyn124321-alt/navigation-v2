...
static const _ActuatorStateArray_type_support_symbol_names_t _ActuatorStateArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ranger_msgs, msg, ActuatorStateArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ranger_msgs, msg, ActuatorStateArray)),
  }
};
...
{
  return &::ranger_msgs::msg::rosidl_typesupport_cpp::ActuatorStateArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ranger_msgs, msg, ActuatorStateArray)() {
  return get_message_type_support_handle<ranger_msgs::msg::ActuatorStateArray>();
}
