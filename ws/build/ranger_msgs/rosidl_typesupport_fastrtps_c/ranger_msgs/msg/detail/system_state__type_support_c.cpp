...
#include "ranger_msgs/msg/detail/system_state__rosidl_typesupport_fastrtps_c.h"
...
using _SystemState__ros_msg_type = ranger_msgs__msg__SystemState;
...
static uint32_t _SystemState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ranger_msgs__msg__SystemState(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ranger_msgs__msg__SystemState;
    is_plain =
      (
...
static size_t _SystemState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ranger_msgs__msg__SystemState(
