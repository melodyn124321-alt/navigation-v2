...
#include "ranger_msgs/msg/detail/motion_state__rosidl_typesupport_fastrtps_c.h"
...
using _MotionState__ros_msg_type = ranger_msgs__msg__MotionState;
...
static uint32_t _MotionState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ranger_msgs__msg__MotionState(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ranger_msgs__msg__MotionState;
    is_plain =
      (
...
static size_t _MotionState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ranger_msgs__msg__MotionState(
