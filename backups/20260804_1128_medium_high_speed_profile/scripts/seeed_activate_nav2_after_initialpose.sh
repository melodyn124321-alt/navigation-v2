...
NAV_START_MAX_SPEED_MPS="${NAV_START_MAX_SPEED_MPS:-0.05}"
NAV_CRUISE_SPEED_MPS="${NAV_CRUISE_SPEED_MPS:-0.16}"
NAV_APPROACH_SLOW_DISTANCE_M="${NAV_APPROACH_SLOW_DISTANCE_M:-0.75}"
NAV_APPROACH_MIN_SPEED_MPS="${NAV_APPROACH_MIN_SPEED_MPS:-0.035}"
