    ...
    def __init__(self):
        ...
        self.localization_to_base_roll_rad = float(
            self.declare_parameter(
                "localization_to_base_roll_rad", -0.010669779).value)
        self.localization_to_base_pitch_rad = float(
            self.declare_parameter(
                "localization_to_base_pitch_rad", -0.274581016).value)
        self.localization_to_base_yaw_rad = float(
            self.declare_parameter(
                "localization_to_base_yaw_rad", -1.570796327).value)
        self.localization_to_base_x_m = float(
            self.declare_parameter(
                "localization_to_base_x_m", 0.042528450).value)
        self.localization_to_base_y_m = float(
            self.declare_parameter(
                "localization_to_base_y_m", 0.666725193).value)
        self.localization_to_base_z_m = float(
            self.declare_parameter(
                "localization_to_base_z_m", -0.915570231).value)
