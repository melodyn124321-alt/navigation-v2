...
BASE_TO_LIDAR_ROLL_RAD="${BASE_TO_LIDAR_ROLL_RAD:-0.274581016}"
BASE_TO_LIDAR_PITCH_RAD="${BASE_TO_LIDAR_PITCH_RAD:--0.010669779}"
BASE_TO_LIDAR_YAW_RAD="${BASE_TO_LIDAR_YAW_RAD:-0.0}"
LOCALIZATION_TO_BASE_ROLL_RAD="${LOCALIZATION_TO_BASE_ROLL_RAD:--0.274595872}"
LOCALIZATION_TO_BASE_PITCH_RAD="${LOCALIZATION_TO_BASE_PITCH_RAD:-0.010270063}"
LOCALIZATION_TO_BASE_YAW_RAD="${LOCALIZATION_TO_BASE_YAW_RAD:--0.002893145}"
LOCALIZATION_TO_BASE_X_M="${LOCALIZATION_TO_BASE_X_M:--0.897418044}"
LOCALIZATION_TO_BASE_Y_M="${LOCALIZATION_TO_BASE_Y_M:--0.139088063}"
LOCALIZATION_TO_BASE_Z_M="${LOCALIZATION_TO_BASE_Z_M:--0.678155856}"
