...
def main():
    args = [
        ...
        "-p", "ultrasonic_stop_distance:=0.60",
        "-p", "ultrasonic_clear_distance:=0.75",
        ...
        "-p", "ultrasonic_required_tail_clearance:=0.30",
        "-p", "ultrasonic_braking_margin:=0.05",
        "-p", "ultrasonic_noise_margin:=0.05",
    ...
    try:
        ...
        wait_until(
            ...
            2.0, "clear reverse permission and detection-range status")
        ...
        print(
            ...
            "clear_reverse=PASS self_echo=PASS near_stop=PASS latch=PASS "
