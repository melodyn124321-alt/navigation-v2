...
ULTRASONIC_TAIL_CLEARANCE_M="${ULTRASONIC_TAIL_CLEARANCE_M:-0.30}"
ULTRASONIC_BRAKING_MARGIN_M="${ULTRASONIC_BRAKING_MARGIN_M:-0.05}"
ULTRASONIC_NOISE_MARGIN_M="${ULTRASONIC_NOISE_MARGIN_M:-0.05}"
ULTRASONIC_STOP_DISTANCE_M="${ULTRASONIC_STOP_DISTANCE_M:-0.60}"
ULTRASONIC_CLEAR_DISTANCE_M="${ULTRASONIC_CLEAR_DISTANCE_M:-0.75}"
...
validate_chassis_lidar_geometry() {
  ...
  echo "Rear sonar safety: sensor_to_tail=${ULTRASONIC_SENSOR_TO_REAR_EDGE_M}m stop=${ULTRASONIC_STOP_DISTANCE_M}m clear=${ULTRASONIC_CLEAR_DISTANCE_M}m tail_clearance>=${ULTRASONIC_TAIL_CLEARANCE_M}m"
}
