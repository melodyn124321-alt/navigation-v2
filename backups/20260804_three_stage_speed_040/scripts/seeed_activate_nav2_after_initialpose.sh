...
NAV_START_SLOW_DISTANCE_M="${NAV_START_SLOW_DISTANCE_M:-0.25}"
NAV_START_MAX_SPEED_MPS="${NAV_START_MAX_SPEED_MPS:-0.08}"
NAV_CRUISE_SPEED_MPS="${NAV_CRUISE_SPEED_MPS:-0.30}"
NAV_APPROACH_SLOW_DISTANCE_M="${NAV_APPROACH_SLOW_DISTANCE_M:-0.70}"
