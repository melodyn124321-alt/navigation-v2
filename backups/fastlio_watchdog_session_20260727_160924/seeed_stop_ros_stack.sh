...
if [[ -x /home/seeed/ros2/scripts/seeed_ks109_dual.sh ]]; then
  /home/seeed/ros2/scripts/seeed_ks109_dual.sh stop || true
fi
...
kill_ros_wrappers "static_transform_publisher.*rear_ultrasonic"
