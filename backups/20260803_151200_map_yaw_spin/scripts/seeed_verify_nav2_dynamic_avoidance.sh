...
grep -q '0.035' <<<"${adapter_spin_effective_rate}" || failed=true
grep -q '1.35' <<<"${adapter_spin_timeout_factor}" || failed=true
grep -q '3.0' <<<"${adapter_spin_timeout_margin}" || failed=true
