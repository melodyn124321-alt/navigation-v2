...
LOCALIZATION_TO_BASE_X_M="${LOCALIZATION_TO_BASE_X_M:-0.9168885}"
LOCALIZATION_TO_BASE_Y_M="${LOCALIZATION_TO_BASE_Y_M:--0.0499652}"
LOCALIZATION_TO_BASE_Z_M="${LOCALIZATION_TO_BASE_Z_M:--0.6643937}"
