...
def main():
    ...
    try:
        ...
        wait_until(
            lambda: "rear ultrasonic self-echo right sensor_2" in driver.status
        ...
        wait_until(
            lambda: "rear ultrasonic blocked left sensor_1" in driver.status
            and driver.left_turn_allowed is False
            and driver.right_turn_allowed is False
            and driver.recent_all_zero(time.monotonic() - 0.20),
        ...
        driver.ranges[0] = math.inf
        wait_until(
            lambda: driver.left_turn_allowed is True
            and driver.right_turn_allowed is True
            and driver.recent_nonzero(time.monotonic() - 0.30),
            6.0, "both turn directions recover after both sides clear")
