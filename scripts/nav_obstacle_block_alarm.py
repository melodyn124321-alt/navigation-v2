...
class NavObstacleBlockAlarm(Node):
    ...
    def publish_marker(self, blocked_for, alarm):
        ...
        # Safety text uses the chassis-front slot.  It stays clear of the
        # ROBOT label behind, NDT quality on the left, and goal status on the
        # right, while remaining above the live point cloud.
        text.pose.position.x = 1.35
